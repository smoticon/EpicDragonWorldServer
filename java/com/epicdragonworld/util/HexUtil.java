...
public class HexUtil
{
	 ...
	 * This call is equivalent to {@link HexUtil#b2HexChars(byte, char[], int)} with parameters (data, null, 0)
	...
	/**
	 * Method to generate the hexadecimal character presentation of an integer This call is equivalent to {@link HexUtil#int2HexChars(int, char[], int)} with parameters (data, null, 0)
	 ...
	 * This call is equivalent to {@link HexUtil#bArr2HexChars(byte[], int, int, char[], int)} with parameters (data, offset, len, null, 0)
