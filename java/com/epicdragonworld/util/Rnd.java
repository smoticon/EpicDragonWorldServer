...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see com.epicdragonworld.util.Rnd#nextDouble()
		 */
	...
	public enum RandomType
	{
		...
		/**
		 * Like {@link com.epicdragonworld.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see com.epicdragonworld.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see com.epicdragonworld.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return int
	 * @see com.epicdragonworld.util.Rnd#get(int n)
	 */
